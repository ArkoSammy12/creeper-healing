...
public final class ExplosionUtils {
    ...
    public static @NotNull List<AffectedBlock> sortAffectedBlocksList(@NotNull List<AffectedBlock> affectedBlocksList, MinecraftServer server){
        ...
        Comparator<AffectedBlock> transparencyComparator = (affectedBlock1, affectedBlock2) -> {
            boolean isAffectedBlock1Transparent = affectedBlock1.getState().isTranslucent(affectedBlock1.getWorld(server), affectedBlock1.getPos());
            boolean isAffectedBlock2Transparent = affectedBlock2.getState().isTranslucent(affectedBlock2.getWorld(server), affectedBlock2.getPos());
