...
public class DoubleAffectedBlock extends AffectedBlock {
    ...
    boolean shouldHealBlock(World world, BlockPos secondBlockPos){
        return ((BlockAccessor)(world.getBlockState(this.getPos()).getBlock())).creeper_healing$isReplaceable() && ((BlockAccessor)(world.getBlockState(secondBlockPos).getBlock())).creeper_healing$isReplaceable();
    }
