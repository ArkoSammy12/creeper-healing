...
public enum ConfigSettings {
    ...
    DROP_ITEMS_ON_GHAST_EXPLOSIONS(new BooleanSetting.Builder(new SettingLocation(SettingGroups.EXPLOSION_ITEM_DROPS.getName(), "drop_items_on_ghast_explosions"), "(Default = false) Whether to drop items when a ghast explodes.",  false)),
    DROP_ITEMS_ON_WITHER_EXPLOSIONS(new BooleanSetting.Builder(new SettingLocation(SettingGroups.EXPLOSION_ITEM_DROPS.getName(), "drop_items_on_wither_explosions"), "(Default = false) Whether to drop items when a wither explodes.", false)),
    DROP_ITEMS_ON_TNT_EXPLOSIONS(new BooleanSetting.Builder(new SettingLocation(SettingGroups.EXPLOSION_ITEM_DROPS.getName(), "drop_items_on_tnt_explosions"), "(Default = false) Whether to drop items when a tnt explodes.", false)),
    DROP_ITEMS_ON_TNT_MINECART_EXPLOSIONS(new BooleanSetting.Builder(new SettingLocation(SettingGroups.EXPLOSION_ITEM_DROPS.getName(), "drop_items_on_tnt_minecart_explosions"), "(Default = false) Whether to drop items when a tnt minecart explodes.", false)),
    DROP_ITEMS_ON_BED_AND_RESPAWN_ANCHOR_EXPLOSIONS(new BooleanSetting.Builder(new SettingLocation(SettingGroups.EXPLOSION_ITEM_DROPS.getName(), "drop_items_on_bed_and_respawn_anchor_explosions"), "(Default = false) Whether to drop items when a bed or respawn anchor explodes.",  false)),
    DROP_ITEMS_ON_END_CRYSTAL_EXPLOSIONS(new BooleanSetting.Builder(new SettingLocation(SettingGroups.EXPLOSION_ITEM_DROPS.getName(), "drop_items_on_end_crystal_explosions"), "(Default = false) Whether to drop items when an end crystal explodes.",  false)),
