...
public final class ConfigUtils {
    ...
    public static <E extends Enum<E>> E getEnumSettingValue(SettingLocation settingLocation) {
        EnumSetting<E> enumSetting = ConfigManagerExtensionsKt.getAsEnumSetting(CONFIG_MANAGER, settingLocation);
        if (enumSetting == null) {
    ...
    public static long getExplosionHealDelay() {
        NumberSetting<Double> explosionHealDelaySetting = ConfigManagerExtensionsKt.getAsDoubleSetting(CONFIG_MANAGER, ConfigSettings.EXPLOSION_HEAL_DELAY.getSettingLocation());
    ...
    public static long getBlockPlacementDelay() {
        NumberSetting<Double> blockPlacementDelaySetting = ConfigManagerExtensionsKt.getAsDoubleSetting(CONFIG_MANAGER, ConfigSettings.BLOCK_PLACEMENT_DELAY.getSettingLocation());
